...
###################################################
### code chunk number 1: SISMID13-structured-models.rnw:54-55
###################################################
require(deSolve)


###################################################
### code chunk number 2: SISMID13-structured-models.rnw:62-64
###################################################
...
###################################################
### code chunk number 3: SISMID13-structured-models.rnw:69-74
###################################################
...
smooth.cases<-loess(measles$Cases[order(measles$TwoYear)]~measles$TwoYear[order(measles$TwoYear)],span=0.3)
lines(smooth.cases$x,smooth.cases$fitted,lwd=2)  #add smooth fit


###################################################
### code chunk number 4: SISMID13-structured-models.rnw:81-94
###################################################
...
###################################################
### code chunk number 5: SISMID13-structured-models.rnw:99-107
###################################################
...
###################################################
### code chunk number 6: SISMID13-structured-models.rnw:112-141
###################################################
...
###################################################
### code chunk number 7: SISMID13-structured-models.rnw:143-158
###################################################
